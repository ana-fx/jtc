...
4. **Coins** — `/work` pays out a random paycheck (100-300 coins) on a 1-hour cooldown. Leveling up also pays a flat coin reward per band: levels 1-5 pay 500, 6-10 pay 750, 11-15 pay 1000, and so on (+250 every 5 levels).
